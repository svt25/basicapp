<div>
    <section class="relative py-6 bg-white bg-gray-100 min-w-screen animation-fade animation-delay">
        <div class="container h-full max-w-5xl mx-auto overflow-hidden rounded-lg shadow">
            ...
            <div class="h-full sm:flex">
                ...
                <div class="flex items-center justify-center space-x-5 w-full p-10 bg-white">
                    <div class="flex items-center justify-center flex-col bg-gradient-to-r from-indigo-400 via-pink-400 to-red-400 text-white shadow-md w-3/4 h-full rounded-lg">
                    ...
                    <form wire:submit.prevent="contactFormSubmit" action="/contact" method="POST" class="w-full">
                        ...
                        <div class="pt-3">
                            <button class="flex px-6 py-3 text-white bg-indigo-500 rounded-md hover:text-white focus:outline-none focus:shadow-outline focus:border-indigo-300 transition duration-500 ease-in-out hover:bg-indigo-700 transform hover:scale-110" type="submit">
